...
//
//
//  Created by Ivan Rzhanoi on 16.4.2024.
//
    ...
    struct v1: AsyncMigration {
        ...
        func prepare(on db: Database) async throws {
            ...
            try await db.schema(BlogPostModel.schema)
                ...
                .field(BlogPostModel.FieldKeys.v1.date, .string, .required)
                .field(BlogPostModel.FieldKeys.v1.content, .string, .required)
                .field(BlogPostModel.FieldKeys.v1.categoryId, .string, .required)
                .foreignKey(BlogPostModel.FieldKeys.v1.categoryId,
                            references: BlogPostModel.schema, .id,
